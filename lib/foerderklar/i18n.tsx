...
const en = {
  ...
  results: {
    ...
    askHint: "Need clarification on a programme or next step? Contact the provider.",
...
const de = {
  ...
  results: {
    ...
    askHint: "Unklarheiten zu einem Programm oder nächsten Schritt? Kontaktiert den Anbieter.",
