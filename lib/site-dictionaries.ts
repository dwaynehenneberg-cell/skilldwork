    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The Reddit Pixel also processes information about page visits and completed bookings, together with online identifiers and device or browser information, so we can measure whether a Reddit advertisement led to a booking.",
        ],
      },
      {
        title: "3. How and why we use your data",
        paragraphs: [
          "We use your data to respond to your inquiry, contact you about the offer you requested, schedule and manage a call, and prepare any requested services. Processing is based on steps you ask us to take before entering into a contract (Art. 6(1)(b) GDPR), or on your consent where a form specifically requests it (Art. 6(1)(a) GDPR). We process limited technical website data, including country-based language selection, based on our legitimate interest in providing a secure, reliable, and usable website (Art. 6(1)(f) GDPR). Reddit advertising measurement is based on our legitimate interest in measuring whether ads lead to bookings (Art. 6(1)(f) GDPR). You may object by emailing us.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "The Reddit Pixel records a page visit and, after Calendly confirms that an appointment was scheduled, a lead event. This does not limit the website or booking function. You may object to this measurement by emailing us.",
        ],
      },
      {
        title: "6. Retention",
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Das Reddit Pixel erfasst einen Seitenbesuch und nach Bestätigung eines gebuchten Calendly-Termins ein Lead-Event. Das schränkt Website oder Buchung nicht ein. Du kannst dieser Messung per E-Mail widersprechen.",
        ],
      },
      {
